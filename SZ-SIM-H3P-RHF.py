...
atomA=[0,0,0]
atomB=[R_length,0,0]
atomC=[R_length*1/2,0,R_length*np.sqrt(3)/2]
ZETA1=2.0925
ZETA2=1.24
ZETA1=ZETA2
ZETA3=ZETA2
...
4*FMdotxy[0].expand()-OBJE.diff(x)
4*FMdotxy[1].expand()-OBJE.diff(y)
4*FMdotxy[2].expand()-OBJE.diff(z)


# In[10]:


[OBJE.diff(x).expand()-2*FMdotxy[0].expand(),
 OBJE.diff(y).expand()-2*FMdotxy[1].expand(),
 OBJE.diff(z).expand()-2*FMdotxy[2].expand()]
